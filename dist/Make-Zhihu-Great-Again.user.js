...
`;
  ...
  const APP_HEADER_COMPONENT_STYLE = `  html[data-zb-theme] .AppHeader,
...
`;
  ...
  const PRIMARY_BUTTON_COMPONENT_STYLE = `  html[data-zb-theme] .Button--blue {${PRIMARY_BUTTON_STYLE}
  }
...
`;
  ...
  const CORNER_BUTTON_COMPONENT_STYLE = `  html[data-zb-theme] .CornerButton {
    background-color: var(--zb-surface) !important;
    border-color: var(--zb-border-strong) !important;
    color: var(--zb-text-muted) !important;
    box-shadow: var(--zb-shadow) !important;
...
`;
  ...
  const VOTE_BUTTON_COMPONENT_STYLE = `  html[data-zb-theme] .VoteButton {
    background-color: var(--zb-primary-soft) !important;
    border-color: transparent !important;
    color: var(--zb-primary) !important;
  }
...
`;
  ...
  const BASE_SURFACES_COMPONENT_STYLE = `  html[data-zb-theme] .Card,
...
`;
  ...
  const SECONDARY_SURFACES_COMPONENT_STYLE = `  html[data-zb-theme] .ProfileSideCreator-analytics,
...
`;
  ...
  const FORM_CONTROLS_COMPONENT_STYLE = `  html[data-zb-theme] .SearchBar-input,
...
`;
  ...
  const CHAT_MODAL_STYLE = `  html[data-zb-theme] .ChatBoxModal > div:has(> .Modal-content) {
    box-sizing: border-box !important;
    background-color: var(--zb-surface) !important;
    border: 1px solid var(--zb-border-strong) !important;
    border-radius: 12px !important;
  ...
  const CHAT_PAGE_CONVERSATION_STYLE = `  html[data-zb-theme]
    .App-main
    .Chat
...
`;
  ...
  const CHAT_PAGE_SIDEBAR_STYLE = `  html[data-zb-theme] .App-main .ChatWrapper > .Chat {
    background-color: var(--zb-surface) !important;
    border: 1px solid var(--zb-border-strong) !important;
    border-radius: 12px !important;
    box-shadow: var(--zb-shadow) !important;
...
`;
  ...
  const HEADER_MESSAGING_POPOVERS_STYLE = `  html[data-zb-theme]
...
`;
  ...
  const MESSAGING_COMPONENT_STYLE = `${HEADER_MESSAGING_POPOVERS_STYLE}${CHAT_PAGE_SIDEBAR_STYLE}${CHAT_PAGE_CONVERSATION_STYLE}${CHAT_MODAL_STYLE}
`;

  const ARROW_ACTION_PANEL_OVERLAY_STYLE = `  html[data-zb-theme] [data-zb-arrow-action-panel-wrapper] {
    background-color: transparent !important;
    border-radius: 8px !important;
  }
...
`;
  ...
  const FAVORITES_MODAL_OVERLAY_STYLE = `  html[data-zb-theme] .FavlistsModal .Modal-inner {
    background-color: var(--zb-surface) !important;
    border: 1px solid var(--zb-border-strong) !important;
    color: var(--zb-text) !important;
    box-shadow: var(--zb-shadow) !important;
...
`;
  ...
  const GIFT_MODAL_OVERLAY_STYLE = `  html[data-zb-theme]
...
`;
  ...
  const POLL_OVERLAYS_STYLE = `  html[data-zb-theme] .VoteTypeSelectorPopover,
  ...
  const VOTER_LIST_OVERLAY_STYLE = `  html[data-zb-theme]
...
`;
  ...
  const CONFIRMATION_DIALOG_OVERLAY_STYLE = `  html[data-zb-theme]
    body
    > div
    > div
...
`;
  ...
  const EDITOR_POPOVERS_OVERLAY_STYLE = `  html[data-zb-theme] .Editable-languageSuggestions,
...
`;
  ...
  const MATERIAL_LIBRARY_MODAL_OVERLAY_STYLE = `  html[data-zb-theme]
...
`;
  ...
  const MEDIA_MODALS_OVERLAY_STYLE = `  html[data-zb-theme] .Modal:has(canvas[alt="二维码"]) .Modal-content div {
    color: var(--zb-text-muted) !important;
  }
...
`;
  ...
  const REFERENCE_MODAL_OVERLAY_STYLE = `  html[data-zb-theme] .ReferenceModal :is(.InputLike, .Select-button) {
    background-color: var(--zb-surface-raised) !important;
    border-color: var(--zb-border-strong) !important;
    color: var(--zb-text) !important;
    border-radius: 6px !important;
...
`;
  ...
  const RESPONSIVE_MODAL_OVERLAY_STYLE = `  html[data-zb-theme]
...
`;
  ...
  const THEME_FOUNDATION_STYLE = `  html[data-zb-theme] {
...
`;
  ...
  const RING_FEEDS_STYLE = `  html[data-zb-theme][data-zb-ring-feeds-page="true"]
    #TopstoryContent
    > div {${SURFACE_TEXT_ONLY_STYLE}
  }
...
`;
  ...
  const RING_FOUNDATION_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"]
    .App-main
    > div:first-child
    > div:nth-child(2)
    > div
...
`;
  ...
  const RING_HOST_FEED_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"]
    .App-main
    > div:first-child
    > div:first-child
    .List {
...
`;
  ...
  const RING_HOST_HEADER_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"] .App-main > div:first-child {
    background-color: var(--zb-page) !important;
    color: var(--zb-text) !important;
  }
...
`;
  ...
  const RING_HOST_INVITE_MODAL_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"]
...
`;
  ...
  const RING_HOST_PIN_TOOLBAR_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"]
    .PinItem
    .ContentItem-actions
    > .PinToolbar-actions {
    box-sizing: border-box !important;
...
`;
  ...
  const RING_HOST_SIDEBAR_STYLE = `  html[data-zb-theme][data-zb-ring-host-page="true"]
    .App-main
    > div:first-child
    > div:nth-child(2)
    > div
...
`;
  ...
  const RING_HOST_STYLE = `${RING_HOST_HEADER_STYLE}${RING_HOST_FEED_STYLE}${RING_HOST_SIDEBAR_STYLE}${RING_HOST_PIN_TOOLBAR_STYLE}${RING_HOST_INVITE_MODAL_STYLE}
`;

  const RING_INDEX_STYLE = `  html[data-zb-theme][data-zb-ring-index-page="true"] .App-main,
...
${RING_FOUNDATION_STYLE}${RING_INDEX_STYLE}${RING_HOST_STYLE}${RING_FEEDS_STYLE}
`;
